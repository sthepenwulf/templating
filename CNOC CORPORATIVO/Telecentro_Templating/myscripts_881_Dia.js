...
var textFile = null,
  ...
  create.addEventListener('click', function () {
    ...
    var mon_ip = document.getElementById('mon_ip').value;
    var mon_dg = document.getElementById('mon_dg').value;
    var mon_mask = document.getElementById('mon_mask').value;
    ...
    var loop_ip = document.getElementById('loop_ip').value;
    var loop_mask = document.getElementById('loop_mask').value;


    output = `conf t
!
hostname ${client_id}-DIA-881
!
!
...
interface FastEthernet4.152
 ...
 ip address ${mon_ip} ${mon_mask}
!
interface FastEthernet4.${vlan} 
 description VPN
...
ip route vrf MONITORIA-CPE 0.0.0.0 0.0.0.0 ${mon_dg}
!
...
snmp-server community TELECENTRO-${client_id} RO
!
control-plane
!
!
...
`
    ...
    link.download = `${client_id} - ${client_address}.txt`;
  }, false);
})();
